    ...
    $sql = "SELECT * from user_registration where  User_Name='".$usrname."' and Contact_No='".$Contact_No."' ";
      $info = $db->query($sql);
          ...
          { 
            ...
            $insert = "insert into user_registration(User_Name,Father_Name,Password,Address,Contact_No) 
        ...
        <div class="modal-body" style="padding:40px 50px;">
          <form  role="form" method="post" action=""> 
            <div class="form-group">
             ...
             <div class="form-group">
             <label for="psw"><span class="glyphicon glyphicon-user"></span> Father Name</label>
              <input type="text" class="form-control" name="fname" required="" placeholder="Enter Father Name">
            </div>
